...
Demonstrates various bot configurations and use cases.

Status: EDUCATIONAL EXAMPLES - Not for production use
Note: These examples use the old SuperTrend bot for demonstration purposes.
For production ICT bot examples, see ICT_README.md and ICT_SMC_README.md
